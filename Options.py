...
class Timer(pygame.sprite.Sprite):
    image = load_image('option3_1.png', -1)  # картинка спрайта
    ...
    def up(self):  # обновление таймера
        self.count -= 1
        self.image = Timer.image.copy()
        self.text = f'{self.count // 60}:{str(self.count % 60).rjust(2, "0")}'  # обновление циферблата
        text1 = self.font1.render(self.text, False, (0, 0, 0))
        self.image.blit(text1, (70, 15))


class Health(pygame.sprite.Sprite):
    image = load_image('option2_1.png', -1)  # картинка спрайта
    ...
    def up(self):  # обновление показателя здоровья
        self.image = Health.image.copy()
...
class Vaccine(pygame.sprite.Sprite):
    image = load_image('option1_1.png', -1)  # картинка спрайта

    def __init__(self, all_count, *group):  # инициализация спрайта
    ...
    def up(self, kill_count):  # обновление шкалы вакцины
        self.image = Vaccine.image.copy()
